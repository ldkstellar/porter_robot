...
{
  new (message_memory) wave_interfaces::msg::Distance(_init);
}

void Distance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<wave_interfaces::msg::Distance *>(message_memory);
  typed_message->~Distance();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Distance_message_member_array[1] = {
  {
    "distance",  // name
    ...
    offsetof(wave_interfaces::msg::Distance, distance),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Distance_message_members = {
  "wave_interfaces::msg",  // message namespace
  "Distance",  // message name
  1,  // number of fields
  sizeof(wave_interfaces::msg::Distance),
...
get_message_type_support_handle<wave_interfaces::msg::Distance>()
{
  return &::wave_interfaces::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wave_interfaces, msg, Distance)() {
  return &::wave_interfaces::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
